...
public class HttpsUtil {
     ...
     * @throws IOException
     */
    public static String getAsString(String url, String charset) throws NoSuchAlgorithmException, UnsupportedEncodingException, KeyManagementException, IOException{
